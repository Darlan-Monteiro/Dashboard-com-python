...
usuarios = {'darlan': '12345678'}
app = Dash(__name__)
auth= dash_auth.BasicAuth(app, usuarios)

df = pd.read_excel(r"C:\Users\SAMSUNG\OneDrive\Área de Trabalho\Documentos\Portfólio PYTHON\Dashboards com python\Vendas.xlsx")
...
app.layout = html.Div(children=[
    html.H1(children='Dashboard de Vendas em Python'),
